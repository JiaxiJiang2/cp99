...
default wu_head_img = "images/1.png"
default guo_head_img = "images/2.png"
default hua_head_img = "images/999.png"
...
screen say(who, what):
    ...
    if not renpy.variant("small"):
            if who is not None and str(who) == "无名":
                add wu_head_img xalign 0.0 yalign 1.0 zoom 0.1
            elif who is not None and str(who) == "郭奉孝":
                add guo_head_img xalign 0.0 yalign 1.0 zoom 0.1
            elif who is not None and str(who) == "华元化":
               add "images/999.png" xalign 0.0 yalign 1.0 zoom 0.1
            elif who is not None and str(who) == "紫鸾":
                add wu_head_img xalign 0.0 yalign 1.0 zoom 0.1
            else:
...
## 短暂闪光屏幕：显示一层半透明实心色并可被脚本显示/隐藏
screen flash(duration=0.08, color="#ffffff", alpha=0.6):
    add Solid(color) xalign 0.5 yalign 0.5 alpha alpha
...
screen main_menu():
    ...
    on "show" action If(
        persistent.lover_ending_unlocked,
        Play("music", music21),
        NullAction()
    )
    ...
    if persistent.lover_ending_unlocked:
        add "images/77.png"
    else:
...
style nvl_entry:
    ...
    ysize gui.nvl_height
                                if who is not None and str(who) == "无名":
                                    add "images/1.png" xalign 0.0 yalign 1.0 zoom 0.333
                                elif who is not None and str(who) == "郭奉孝":
                                    add "images/2.png" xalign 0.0 yalign 1.0 zoom 0.333
                                elif who is not None and str(who) == "华元化":
                                    add "images/999.png" xalign 0.0 yalign 1.0 zoom 0.333
                                elif who is not None and str(who) == "紫鸾":
                                    add "images/1.png" xalign 0.0 yalign 1.0 zoom 0.333
                                else:
                                    add SideImage() xalign 0.0 yalign 1.0
